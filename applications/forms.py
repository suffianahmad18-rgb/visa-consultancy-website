...
class ApplicationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            # Education
            'last_qualification': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., Bachelor of Science'}),
            ...
            'preferred_course': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., MS in Computer Science'}),
            ...
            'visa_refusal_details': forms.Textarea(attrs={'rows': 3, 'class': 'form-control', 'placeholder': 'If yes, please provide details...'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['destination'].label_from_instance = lambda obj: f"{obj.country_name} - {obj.get_country_code_display()}"
